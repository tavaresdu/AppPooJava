    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < listagemAluno.length; i++) {
            ...
            Universidade universidade = new Universidade(
                    JOptionPane.showInputDialog(
                            "Informe a razão social da universidade do " +
                                    n + "º aluno:"
                    ),
                    JOptionPane.showInputDialog(
                            "Informe o e-mail da universidade do " +
                                    n + "º aluno:"
                    ),
                    JOptionPane.showInputDialog(
                            "Informe o telefone da universidade do " +
                                    n + "º aluno:"
                    ),
                    new Endereco(
                            JOptionPane.showInputDialog(
                                    "Informe o bairro da universidade do " +
                                            n + "º aluno:"
                            ),
                            JOptionPane.showInputDialog(
                                    "Informe a cidade da universidade do " +
                                            n + "º aluno:"
                            ),
                            JOptionPane.showInputDialog(
                                    "Informe a UF da universidade do " +
                                            n + "º aluno:"
                            )
                    )
            );
